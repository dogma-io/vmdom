...
describe('HTMLElement', () => {
  ...
  describe('blur()', () => {
    it('should not error throw when onblur event handler is not present', () => {
      expect(() => {
        instance.blur()
      }).not.toThrow()
    })
  ...
  describe('click()', () => {
    it('should not error throw when onclick event handler is not present', () => {
      expect(() => {
        instance.click()
      }).not.toThrow()
    })
  ...
  describe('focus()', () => {
    it('should not error throw when onfocus event handler is not present', () => {
      expect(() => {
        instance.focus()
      }).not.toThrow()
    })
