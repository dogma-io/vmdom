...
export function itShouldImplementWindowOrWorkerGlobalScopeInterface(
  getInstance,
) {
  describe('WindowOrWorkerGlobalScope interface', () => {
    let instance
    ...
    it('should have empty sets for interval/timeout ids', () => {
